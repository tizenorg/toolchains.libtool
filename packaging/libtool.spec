...
%{_includedir}/libltdl
%changelog
* Fri Mar  7 2014 Dohyung Kim <dohyung2.kim@samsung.com> - None 
- PROJECT: external/libtool
- COMMIT_ID: 3f27a11eef34b1c0d32621c6b45bce898919b792
- PATCHSET_REVISION: 3f27a11eef34b1c0d32621c6b45bce898919b792
- CHANGE_OWNER: \"DoHyung Kim\" <dohyung2.kim@samsung.com>
- PATCHSET_UPLOADER: \"DoHyung Kim\" <dohyung2.kim@samsung.com>
- CHANGE_URL: http://slp-info.sec.samsung.net/gerrit/440983
- PATCHSET_REVISION: 3f27a11eef34b1c0d32621c6b45bce898919b792
- TAGGER: Dohyung Kim <dohyung2.kim@samsung.com>
- Gerrit patchset approval info:
- Newton Lee <newton.lee@samsung.com> Code-Review : 2
- DoHyung Kim <dohyung2.kim@samsung.com> Verified : 1
- CHANGE_SUBJECT: install license file(libtool-ltdl)
- install license file(libtool-ltdl)
* Wed Mar 30 2011 Junfeng Dong <junfeng.dong@intel.com> - 2.2.6b
- Fix BMC14847: lots of warning on AC_LANG_CONFTEST.
* Thu Feb  4 2010 Anas Nashif <anas.nashif@intel.com> - 2.2.6b
- Disable embedding buildhost name in headers
* Tue Dec  1 2009 Passion Zhao <passion.zhao@intel.com> - 2.2.6b
- Update to 2.2.6b to fix CVE-2009-3736:
  ltdl.c attempts to open a .la file in the current directory
* Thu Jan  8 2009 Anas Nashif <anas.nashif@intel.com> 2.2.6
- Update to 2.2.6a
...
* Thu Apr  5 2007 Karsten Hopp <karsten@redhat.com> 1.5.22-11
...
* Thu Feb  8 2007 Karsten Hopp <karsten@redhat.com> 1.5.22-9
...
* Thu Dec  7 2006 Karsten Hopp <karsten@redhat.com> 1.5.22-7
...
* Tue Jun  6 2006 Karsten Hopp <karsten@redhat.de> 1.5.22-4
...
* Tue Feb  7 2006 Jesse Keating <jkeating@redhat.com> - 1.5.22-2.1
- rebuilt for new gcc4.1 snapshot and glibc changes
* Mon Feb  6 2006 Karsten Hopp <karsten@redhat.de> 1.5.22-2
...
* Fri Sep  9 2005 Karsten Hopp <karsten@redhat.de> 1.5.20-1
- update
* Thu Sep  8 2005 Florian La Roche <laroche@redhat.com>
...
* Thu Oct  2 2003 Florian La Roche <Florian.LaRoche@redhat.de>
- rebuild
...
* Sat Feb  8 2003 Florian La Roche <Florian.LaRoche@redhat.de> - 1.4.3-5
...
* Tue Jan  7 2003 Karsten Hopp <karsten@redhat.de> 1.4.3-2.2
...
* Mon Oct  7 2002 Phil Knirsch <pknirsch@redhat.com>  1.4.2-12.2
...
* Wed Jan  9 2002 Tim Powers <timp@redhat.com> 1.4.2-4
- automated rebuild
...
- s/Copyright/License/
* Wed Jul  4 2001 Karsten Hopp <karsten@redhat.de>
...
* Thu Jun  7 2001 Florian La Roche <Florian.LaRoche@redhat.de>
...
* Wed May  9 2001 Florian La Roche <Florian.LaRoche@redhat.de>
...
* Thu May  7 1998 Donnie Barnes <djb@redhat.com>
- fixed busted group
